		...
		<div id="content">
			<div id="user">
				<form:form
					...
					<img id="img-check" src="${pageContext.request.contextPath }/assets/images/check.png" style="width:30px; vertical-align: bottom; display: none"><br>
					<p style="color:#f00; text-align:left; padding-left:0">
						<form:errors path="email" />
					</p>
					
					<label class="block-label"><spring:message code="user.join.label.password" /></label><br>
					<form:password path="password"/>
					<p style="color:#f00; text-align:left; padding-left:0">
						<form:errors path="password" />
					</p>
		
						<label class="lbock-label">성별</label>
						<!-- 여기 수정하기 -->
